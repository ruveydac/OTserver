...
1. **Open Source (GNU AGPLv3).** The community edition is available under the
...
2. **Commercial License.** A separate commercial license is available for
   enterprises, SaaS providers, or organizations that need to integrate
   OTserver into proprietary systems without the AGPLv3 copyleft obligations.

For a commercial license, custom SLA support, enterprise features, managed
hosting, or help choosing the right license, visit
[otserver.org/enterprise](https://otserver.org/enterprise/).
